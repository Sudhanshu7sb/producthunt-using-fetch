    ...
    <>
      <article className="flex box mb-0">
        ...
        <div className="product-details flex">
          <Productimage
            imgSrc={props.prod.thumbnail.image_url}
            title={props.prod.tagline}
          />
      ...
      <div className="about-product content">
        ...
        <div>
          <a href="##" className="comment-box px-1 py-1 mr-2">
            {props.productdetails.comments_count}
            <i className="fas fa-comment mr-3"></i>
          </a>
          <a href="##">{props.productdetails.topics.map((topic) => topic.name)[0]}</a>
        </div>
      </div>
    </>
  );
